...
export function MobileProjectSearch({
  linkedProjectId,
  linkedProjectCode,
  linkedProjectName,
  onSelect,
  onClear,
}: MobileProjectSearchProps) {
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {linkedProjectId && (
          <div className="flex items-center gap-2 text-xs bg-blue-50 text-blue-700 px-2 py-1 rounded-md">
            ...
            <span className="truncate max-w-[150px]">【{linkedProjectCode}】{linkedProjectName}</span>
            <button
              type="button"
              onClick={onClear}
            ...
            {projects.length === 0 ? (
              ...
              <div className="space-y-1">
                {projects.map((project) => (
                  <div
                    key={project.id}
                    className="flex items-center gap-1 p-1.5 rounded hover:bg-muted cursor-pointer text-xs"
